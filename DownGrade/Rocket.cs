        ...
        public override void Collide(Sprite s)
        {
                ...
                if (currentHealth <= 0)
                {
                    Asteroid_Explosion _asteroid =
                        (Asteroid_Explosion) Spawner.Instance.Spawn(Spawner.TypeOfGameObject.AsteroidBig_Explosion_64);
                    _asteroid.Position = new Vector2(PositionX - 60f, PositionY - 60f);
                    _asteroid.Scale = 2f;
